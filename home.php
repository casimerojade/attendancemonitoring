  ...
  <section id="feature" class="transparent-bg"   >
        <div class="container bg">
          <div class="row">
            ...
            <li><a href="qr_scanning/qr_scanning.html"><i class="icon-info-sign"></i>QR Scanning</a></li>
                          ...
                          <div class="title_index">
                                ...
                                <div class="row-fluid">
                                  <div class="span12"></div>
                                      <div class="row-fluid">
                                        <div class="span10">
                                        <img class="index_logo" src="images/sjclogo1.png" style="width: 500px; height:auto;">
                                        </div>             
                                      </div>                    
                                </div>  
