...
<link href="<?php echo web_root; ?>css/css/bootstrap-responsive.min.css" rel="stylesheet" media="screen">
  ...
  <style>
        body {
            background-image: url('images/sjc_background.png');
...
<body id="login" style="">  
  ...
  <div class="limiter">
    <div class="container-login100"style="background-image: url('images/sjc_background.png');"> 
      <div class="wrap-login100"style="background-color: rgba(255, 255, 255, 0.7);">
        <div class="login100-form-title"style="background-color: rgba(0, 128, 0, 0.7);"> 
  ...
  <!--         <div class="flex-sb-m w-full p-b-30">
          ...
          <div class="container-login100-form-btn" >
            <button class="login100-form-btn" type="submit" name="btnLogin" style="background-color: orange;">
              Login
            </button>
          </div>
        </form>
...
if(isset($_POST['btnLogin'])){
  ...
  //it creates a new objects of member
    ...
    if ($res==true) { 
       message("You're login as ".$_SESSION['ACCOUNT_TYPE'].".","success");
